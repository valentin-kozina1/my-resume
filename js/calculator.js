...
function calculateSum() {
  ...
  const websiteCart = 
  document.querySelector('#calculator-form-input-cart input:checked')
  const websiteReception = 
  document.querySelector('#calculator-form-input-reception input:checked')
  ...
  websiteCartValue = converCartOptionToPrice(websiteCart.value);
  websiteReceptionValue = converReceptionOptionToPrice(websiteReception.value);

  renderSum(websiteTypeValue+technologiesValue+websiteCartValue+websiteReceptionValue);
}
