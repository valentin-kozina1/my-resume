...
const RequestRecieveModal = document.querySelector('#request-recieved');
...
callbackform.addEventListener('submit', function(event) {
	...
	RequestRecieveModal.classList.add('modal-active'); 

	setTimeout(function() {
		RequestRecieveModal.classList.remove('modal-active');		
	}, 2000)
})
